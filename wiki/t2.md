...
//
github.com
baidu:git如何checkout远程分支, //git checkout -b 分支名 [-t|--track] origin/分支名
git checkout远端分支到本地 https://blog.csdn.net/myqq1418/article/details/128465943
git 本地分支如何关联远程分支(-u|--set-upstream) weixin_37646636/article/details/135406686
git push --set-upstream origin/release, git branch --set-upstream-to=origin/release2 rel3
baidu:github设置可见性, github怎么改为public https://worktile.com/kb/ask/515150.html
/
